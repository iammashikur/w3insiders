        ...
        <div class="-mx-4 flex flex-wrap items-center">
            <div class="w-full px-4">
                <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
                    ...
                    Your Trusted Partner for Web and Software Solutions in Bangladesh!
                    </h1>
                    <p class="mx-auto mb-9 max-w-[700px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                    we craft digital experiences that speak the language of success! Whether you're dreaming of a stunning website for your business, a seamless online store, or a dynamic news portal, we're here to turn your ideas into reality.
                    </p>
