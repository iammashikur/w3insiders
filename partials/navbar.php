...
$menu = [
    'Home' => '#home',
    'Services' => [
        'Custom Websites' => 'custom-websites.html',
        'Business Websites' => 'business-websites.html',
        'Ecommerce Websites' => 'ecommerce-websites.html',
        'News Portals' => 'news-portals.html',
        'Blog Websites' => 'blog-websites.html',
    ],
    'Software Solutions' => [
        'POS Software' => 'pos-software.html',
        'CRM' => 'crm.html',
        'Custom Software' => 'custom-software.html',
    ],
    'Blog' => 'blog-grids.html',
    'Contact' => '#contact',
    'Pages' => [
        'About Us' => 'about.html',
        'Pricing' => 'pricing.html',
        'Contact Us' => 'contact.html',
        'Blog Grids' => 'blog-grids.html',
         ...
         <div class="relative -mx-4 flex items-center justify-between">
             <div class="w-60 max-w-full px-4">
                 <a href="index.html" class="navbar-logo block w-full py-5">
                     <img src="assets/images/logo/logo.png" alt="logo" class="header-logo w-full" />
                 </a>
             </div>
                             ...
                             <?php foreach ($menu as $key => $value) : ?>
                                     ...
                                     <li class="submenu-item group relative">
                                         ...
                                         <div class="submenu relative left-0 top-full hidden w-[250px] rounded-sm bg-white p-4 transition-[top] duration-300 group-hover:opacity-100 dark:bg-dark-2 lg:invisible lg:absolute lg:top-[110%] lg:block lg:opacity-0 lg:shadow-lg lg:group-hover:visible lg:group-hover:top-full">
                                             ...
                                             <?php foreach ($value as $key => $value) : ?>
                                                 ...
                                                 <a href="<?= $value ?>" class="block rounded px-4 py-[10px] text-sm text-body-color hover:text-primary dark:text-dark-6 dark:hover:text-primary">
                                                     <?= $key ?>
                                                 </a>
                                             <?php endforeach; ?>
                                 ...
                                 <?php else : ?>
                                     ...
                                     <li class="group relative">
                                         <a href="<?= $value ?>" class="ud-menu-scroll mx-8 flex py-2 text-base font-medium text-dark group-hover:text-primary dark:text-white lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70">
                                             <?= $key ?>
                                         </a>
                                     </li>
